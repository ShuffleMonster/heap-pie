...
const _CONTRACT_ADDRESS = "0x3A9FfF453d50D4Ac52A6890647b823379ba36B9E";
...
var eth = new Eth(new Eth.HttpProvider("https://mainnet.infura.io/v3/498f306b74484e868a572298b6e8a1eb"));
...
// tokens minted
el_safe('#TokensMinted2').innerHTML = "<span style='color: white;'><b>" + current_supply.toLocaleString() + " " + _CONTRACT_SYMBOL + "</b></span>"

  //  tokens burned top
  total_supply = getValueFromStats('Total Supply', stats)
  burnt_tokens = (21000000 - total_supply)
  el_safe('#TokenstopBurned').innerHTML = "<span style='color: red;'><b><a href='https://etherscan.io/token/0x3A9FfF453d50D4Ac52A6890647b823379ba36B9E?a=0x0000000000000000000000000000000000000000' target='blank' style='color: red;'>" + burnt_tokens.toLocaleString() + " " + _CONTRACT_SYMBOL + "</a></b></span>"
